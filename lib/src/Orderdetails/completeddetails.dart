            ...
            child: Column(
              children: [
                FutureBuilder<List<InvoiceDetails>>(
                  future: APIServices().fetchUserInvoiceDetails(widget.idInvc, StaticValue.idAccount),
                                  ...
                                  Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          TextButton(
                                            style: TextButton.styleFrom(fixedSize: Size(125, 0)),
                                            onPressed: () {
                                              Navigator.push( context, MaterialPageRoute(builder: (context) => SupplierPage(idSupp: invList[index].idSupplier)));
                                            },
                                            child: const Row(
                                                                                  ...
                                                                                  child: Container(
                                                                                      ...
                                                                                      child: Column(children: [
                                                                                        RatingBar(
                                                                                          ...
                                                                                          onRatingChanged: (value) => ratingStar = value,
                                                                                          initialRating: 0,
                                                                                          isHalfAllowed: false,
