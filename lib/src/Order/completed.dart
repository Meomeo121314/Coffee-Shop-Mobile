...
import 'package:ila/src/Orderdetails/completeddetails.dart';
        ...
        child: InkWell(
          ...
          onTap: () {
            Future<List<InvoiceDetails>> ls = APIServices()
                .fetchUserInvoiceDetails(invC!.id!, StaticValue.idAccount);
            ls.then((value) {
              caculateTotalInvoiceDetails(value, invC!.id!);
              APIServices().autoCheckConfirmUser(invC!.id);
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Padding(
                              ...
                              child: Image.asset(
                                  'images/assets/icon/package.png',
                                  width: 35,
                                  height: 35,
                                  fit: BoxFit.cover,
